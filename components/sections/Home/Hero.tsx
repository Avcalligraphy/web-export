  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div 
          className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 md:gap-6 mt-6 md:mt-8 w-full mx-auto max-w-[582px] px-4"
          variants={itemVariants}
        >
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
          >
            <Button variant="primary" size="md" className="w-full sm:w-auto sm:flex-1 rounded-[100px] border border-gray-100 text-sm md:text-base">
