      ...
      <div className="flex flex-col items-center justify-center h-full">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 sm:gap-8 lg:gap-5 w-full">
            <div className="flex-1">
                <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-foreground font-urbanist">Let's Build Your Brand for the Global Market</h2>
                <p className="text-xs sm:text-sm md:text-base lg:text-lg text-foreground/50 font-urbanist font-regular mt-3 sm:mt-4">Partner with us to create custom packaging and private label briquettes tailored to your country's market demand. From design to shipment, we ensure premium quality and reliable export service.</p>
            </div>
