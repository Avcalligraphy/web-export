      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="flex flex-col">
            <h3 className="text-2xl font-bold text-foreground font-urbanist mb-4">
              LOGO
            </h3>
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-primary border border-gray-200 flex items-center justify-center hover:bg-secondary transition-colors"
                aria-label="Facebook"
              >
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-foreground/50 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
